...
class ContatosTest < ApplicationSystemTestCase
  ...
  test "creating a Contato" do
    ...
    fill_in "Chefe", with: @contato.chefe
    fill_in "Departamento", with: @contato.departamento
    fill_in "Email", with: @contato.email
    fill_in "Locacao", with: @contato.locacao
    fill_in "Nome", with: @contato.nome
    fill_in "Secretaria", with: @contato.secretaria
